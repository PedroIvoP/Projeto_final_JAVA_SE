...
public class ConsultaCarro extends javax.swing.JFrame {
    ...
    Login ADM;
    /**
     * Creates new form ConsultaCarro
     */
    ...
    private void initComponents() {
        ...
        selectConsultaCliente.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Placa", "Ano", "Modelo", "Fabricante" }));
        ...
        jLabel1.setText("Consulta de Carros");
        ...
        consultaCarro.setBackground(new java.awt.Color(153, 153, 153));
    ...
    private void buttonConsultaClienteConsultarClientes(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConsultaClienteConsultarClientes
        ...
        if (selectConsultaClienteGeral.isSelected()) {
            ...
            sql = "SELECT * FROM carro ORDER BY fabricante ASC";
            ...
            sql = "SELECT * FROM carro WHERE " + itemSelecionado + " LIKE '" + valorDigitado + "' ORDER BY fabricante ASC ";
            conexao = ConnMySQL.conectar();
        }
    ...
    private void buttonGerarArquivoConsultaClienteGerarArquivo(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGerarArquivoConsultaClienteGerarArquivo
        ...
        try{
            FileWriter caminho = new FileWriter("C:\\JAVA\\Relatorio_de_carros_"+ i +".txt");
            BufferedWriter arquivo = new BufferedWriter(caminho);

            arquivo.write("\n\t\tRELATÓRIO DE CARROS\n\n");

            for (Carro c : arrayCarro) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaCarro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
